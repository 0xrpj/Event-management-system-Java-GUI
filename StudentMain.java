...
public class StudentMain extends JFrame {
    ...
    StudentMain(String uniID) {
        ...
        Object[] columnNames2 = { "Event id", "Name", "Date", "Time", "Location" };
        ...
        scrollPane2.setBorder(BorderFactory.createTitledBorder("Events you've booked"));
        tablePanel.add(scrollPane2);

        try {
            ResultSet resultBookSet = reg.getBookingData(uniID);
        ...
        deleteButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (rowNo == -1) {
                    ...
                    String event_id_cancel = (String) tableModel2.getValueAt(rowNo, 0);
                    // reg.delete(delete_id);
                    reg.cancel(event_id_cancel, uniID);
        ...
        bookEvent = new JButton("Book");
        bookEvent.setFont(font1);
        bookEvent.setBackground(Color.BLACK);
        bookEvent.setForeground(Color.WHITE);
        bookEvent.setFocusPainted(false);

        inputPanel.add(bookEvent);
        bookEvent.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (getEventID.trim().isEmpty()) {
                    ...
                    reg.bookEvent(getEventID, uniID);
